    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <?php foreach($transaksi as $tr) : ?>
                        ...
                        <tr class="text-success">
                            ...
                            <td>:</td>
                            <td><button class="btn btn-sm btn-success">Rp. <?php echo number_format($tr->harga_sewa * $jmlHari,0,',','.') ?></button></td>
                        </tr>
        ...
        <div class="col-md-4">
            <div class="card" style="margin-top: 180px">
                ...
                <div class="card-body">
                    <p class="text mb-3">Silahkan Melakukan Pembayaran Dalam Waktu 1x24 Jam Melalui Nomor Rekening Dibawah Ini</p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Bank Mandiri - 2398423940234</li>
                            <li class="list-group-item">Bank BCA - 3294324327</li>
                            <li class="list-group-item">Bank BNI - 392842394</li>
                        </ul>
