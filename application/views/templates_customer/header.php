...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="shortcut icon" href="assets/assets_shop/img/icon.png" type="image/png" />

    <title>Lora RentCar</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="dashboard" class="logo">
                            <h2 class="text-white mt-1">Butar Laundry</h2>
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('customer/data_mobil') ?>">Promo</a></li>
                                <li><a href="<?php echo base_url('register') ?>">Daftar</a></li>
                                <?php if($this->session->userdata('nama')) { ?><li><a href="<?php echo base_url('auth/logout') ?>">Welcome <?php echo $this->session->userdata('nama') ?><span> | Logout</span></a></li>
                                <?php } else { ?>
